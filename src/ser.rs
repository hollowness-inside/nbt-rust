...
impl<W: io::Write> Serializer<W> {
    ...
    pub fn start_compound(mut self, name: &str) -> Result<CompoundSerializer<W>> {
        self.write_header(TagType::Compound, name)?;
